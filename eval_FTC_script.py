...
from utils.environment_creator import par_pz_env_2x2_creator, init_env_params
...
for alpha, checkpoint_dir_name in alpha_checkpoint_zipped: 
    ...
    for sumo_seed in SUMO_SEEDS:
        ...
        env_params_eval = init_env_params(net_file_abs = net_file_abs,
                                          route_file_abs = route_file_abs, 
