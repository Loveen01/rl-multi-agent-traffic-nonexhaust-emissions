...
def init_env_params(net_file_abs, route_file_abs, reward_function=None, observation_function=None, num_seconds=None, sumo_seed=None, fixed_ts=False, render=False):
        
        env_params = {"net_file": net_file_abs,
